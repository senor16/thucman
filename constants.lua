...
GHOST_FORCE_CHASE = {20, 30, 40, 40, 40}
GHOST_BLUE_TIME = {12, 111, 10, 9, 8}
GHOST_TRANSITIONS = {}
GHOST_TRANSITIONS[1] = {{7, 20}, {7, 20}, {5, 20}, {5, 0}}
GHOST_TRANSITIONS[2] = {{7, 20}, {7, 20}, {5, 17}, {5, 0}}
GHOST_TRANSITIONS[3] = {{7, 20}, {7, 20}, {5, 13}, {0.01, 0}}
GHOST_TRANSITIONS[4] = {{7, 20}, {7, 20}, {5, 14}, {0.01, 0}}
GHOST_TRANSITIONS[5] = {{7, 20}, {7, 20}, {5, 14}, {0.01, 0}}
BONUS = "BONUS"
PACMAN = "@"
